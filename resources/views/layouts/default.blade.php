...
<head>
    ...
    <style>
            ...
            --main-footer-bg-color: light-dark(#008941,#008941);
            --main-footer-text-color: light-dark(#ffffff, #ffffff);
            --main-footer-top-border-color: light-dark(#008941,#008941);
        ...
        /* Header top positioning adjustments */
...
{{--                                        </li>--}}
            ...
            <aside class="main-sidebar" style="position: fixed; top: 0; bottom: 0; overflow-y: auto;">
                    ...
                    <ul class="sidebar-menu" data-widget="tree" {{ \App\Helpers\Helper::determineLanguageDirection() == 'rtl' ? 'style="margin-right:12px' : '' }}>
                        ...
                        @can('reports.view')
                            <li class="treeview{{ (request()->is('reports*') ? ' active' : '') }}">
                                ...
                                <ul class="treeview-menu">
                                    {{-- in all li extra curlie is remove --}}
            ...
            {{-- <footer class="main-footer hidden-print foot-div" style="display:grid;flex-direction:column;"> --}}
            
            {{-- <footer class="hidden-print foot-div "> --}}

            {{-- This line is for make footer fixed at bottom --}}
            {{-- <footer class="hidden-print main-footer" 
            style="position: fixed; bottom: 0; left: 0; width: 100%; 
            padding: 20px 0; background-color: #0C8241; 
            color: #ffffff; text-align: center; z-index: 9999;"> --}}

            {{-- <footer class="hidden-print main-footer" 
            style="position: static; bottom: 0; z-index: 9999; width: 100%;"> --}}

            <footer class="hidden-print main-footer " >
                <div class="text-center" >
                    <p id="foot-div ">©Copyright Plexus Cloud, All Rights Reserved.</p>
                </div>
