    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-10 col-lg-offset-1">
                <h1 class="page-header"><img src="../img/logo.png" style="height: 65px;" alt="Snipe-IT logo">
                    {{ trans('general.pre_flight') }}</h1>
            </div>
            <div class="col-lg-12">
                ...
                <div class="row bs-wizard" style="border-bottom:0;">
                    ...
                    <div class="col-xs-3 bs-wizard-step {{ $step > 1 ? 'complete' : 'active' }}">
                        ...
                        <div class="bs-wizard-info text-center" style="padding-left: 90px;">
                            {{ trans('general.setup_config_check') }}</div>
                    </div>

                    <div
                        class="col-xs-3 bs-wizard-step {{ $step == 2 ? 'active' : ($step < 2 ? 'disabled' : 'complete') }}">
                        <!-- complete -->
                    ...
                    <div
                        class="col-xs-3 bs-wizard-step {{ $step == 3 ? 'active' : ($step < 3 ? 'disabled' : 'complete') }}">
                        <!-- complete -->
                    ...
                    <div
                        class="col-xs-3 bs-wizard-step {{ $step == 4 ? 'active' : ($step < 4 ? 'disabled' : 'complete') }}">
                        <!-- active -->
            ...
            <div class="col-lg-10 col-lg-offset-1" style="padding-top: 50px;">
                ...
                <div class="box box-default">
                    <div class="box-header with-border">
                        <h4><i class="{{ $icon ?? '' }}"
                                style="--fa-animation-duration: 10s; --fa-animation-iteration-count: 3;"></i>
                            {{ $section }}</h4>
                    </div>
                    <div class="box-body">
